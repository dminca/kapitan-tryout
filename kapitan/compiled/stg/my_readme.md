...
charts:
  gitlab:
    ...
    helm_values:
      ...
      global:
        ...
        batch:
          cronJob:
            apiVersion: batch/v1
        hosts:
          domain: stg.myvpc.in.example.com
          gitlab:
            name: gitlab.stg.myvpc.in.example.com
        hpa:
        ...
        pages:
          ...
          enabled: true
          host: pages.stg.myvpc.in.example.com
          objectStore:
            bucket: gitlab-pages
            connection:
              secret: gitlab-rails-storage
      ...
      upgradeCheck:
        enabled: true
    instance_name: gitlab.stg.myvpc.in.example.com
    name: gitlab
  ...
  minio:
    ...
    helm_values:
      ...
      ingress:
        ...
        enabled: true
        hostname: console.stg.myvpc.in.example.com
...
kapitan:
  compile:
  - input_params:
      compile_path: /tmp/tmppj5qbj1b.kapitan/compiled/stg/.
    input_paths:
    - templates/docs/my_readme.md
    input_type: jinja2
    output_path: .
